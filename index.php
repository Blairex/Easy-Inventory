...
<head>
  ...
  <style>
    ...
    .feature-card:hover p {
      color: #003d66;
      /* text changes to dark blue for contrast */
    }
...
<body>
  ...
  <nav>
    ...
    <div class="nav-links">
      ...
      <button class="login-btn" onclick="location.href='easy3.html'">Login</button>
    </div>
  </nav>
  ...
  <section class="hero">
    ...
    <p>Manage orders. Track inventory. Handle billing. Oversee warehouses.
  ...
  <section class="features-section" id="features">
    ...
    <div class="features-grid">
      ...
      <div class="feature-card">
        ...
        <p>Add, edit, and categorize products with images, SKUs, and detailed descriptions.</p>
      </div>
